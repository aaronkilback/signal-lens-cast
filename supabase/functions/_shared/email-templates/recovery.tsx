...
export const RecoveryEmail = ({
  ...
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>Reset your AEGIS credentials</Preview>
    <Body style={main}>
      <Container style={container}>
        <Img
          ...
          style={logo}
        />
        <Heading style={h1}>Credential Reset Requested</Heading>
        <Text style={text}>
          A request was made to reset your AEGIS access credentials. Use the
          secure link below to set a new password.
        </Text>
